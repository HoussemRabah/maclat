...
TextStyle textStyleSouTitle = TextStyle(fontSize: 20.0, fontWeight: FontWeight.w500);
TextStyle textStyleTitle = TextStyle(fontSize: 30.0, fontWeight: FontWeight.w900);
